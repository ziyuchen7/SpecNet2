...
epoch = zeros(6,1);
batch = zeros(6,1);
c(1) = 3; c(2) = 2.6; c(3) = 2.1; c(4) = 31; c(5) = 15.7; c(6) = 9.9;
epoch(1) = 800; epoch(2) = 923; epoch(3) = 1142; epoch(4) = 150; epoch(5) = 152; epoch(6) = 242;
batch(1) = 45; batch(2) = 90; batch(3) = 180; batch(4) = 2; batch(5) = 4; batch(6) = 8;
...
figure(1)
legend('','SpecNet1-local bs=45','','SpecNet1-local bs=90','','SpecNet1-local bs=180',...
