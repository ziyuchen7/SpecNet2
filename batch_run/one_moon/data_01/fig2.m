...
net1_full = load(['./LA/evecs_nosearch/spec1_full-la.mat']);

net1_local = load(['./LA/evecs_nosearch/spec1_local-la.mat']);

net1_neighbor = load(['./LA/evecs_nosearch/spec1_neighbor-la.mat']);

net2_full = load(['./LA/evecs_nosearch/spec2_full-la.mat']);

net2_local = load(['./LA/evecs_nosearch/spec2_local-la.mat']);

net2_neighbor = load(['./LA/evecs_nosearch/spec2_neighbor-la.mat']);
...
title('First nontrivial eigenvector')
set(gca,'fontsize',24)
...
legend('SpecNet1-full','SpecNet1-local','SpecNet1-neighbor','SpecNet2-full',...
    'SpecNet2-local','SpecNet2-neighbor','Location','southwest')
title('Second nontrivial eigenvector')
set(gca,'fontsize',24)
